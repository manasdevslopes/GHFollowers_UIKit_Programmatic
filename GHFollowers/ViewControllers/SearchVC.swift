...
// UI Configure and NSLayout Constraints
extension SearchVC {
  func configureLogoImageView() {
    ...
    // Add theconstraint to logo image
  ...
  func configureTextField() {
    // Setting the delegate for TextField. self here means SearchVC
...
// UITextFieldDelegate: - Delegate basically listens to VC for a userNameTextField
